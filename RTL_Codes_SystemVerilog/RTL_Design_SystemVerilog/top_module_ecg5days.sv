    ...
    always @(posedge CLK) begin
        ...
        4'b0111: begin
         B[0] <= 0; B[1] <= 0; B[2] <= 0; 
                ...
                A[3] <= 0; A[4] <= 0; A[5] <= 0; 
                A[6] <= 0; A[7] <= 0;
        if (time_step == 8'b10001000)  // If time_step is 96
                   time_step <= 8'b0;
...
//                A[6] <= {P[0][47], P[0][23:0]}; A[7] <= {P[0][47], P[0][23:0]};
                ...
                if (time_step == 8'b11111111 || time_step == 8'b0000000 || time_step == 8'b0000001 ) begin
...
//            P_reg[7] <= {P[7][47], P[7][23:0]};
        ...
        else if ((time_step == 8'b0000000) && ((counter == 4'b1000) || (counter == 4'b1001))) begin
            //P_reg <= P;                   // Bssign P to P_reg
...
assign X_internal[0] = (P_reg[0] >>> 16);
assign X_internal[1] = (P_reg[1] >>> 16);
assign X_internal[2] = (P_reg[2] >>> 16);
assign X_internal[3] = (P_reg[3] >>> 16);
assign X_internal[4] = (P_reg[4] >>> 16);
assign X_internal[5] = (P_reg[5] >>> 16);
assign X_internal[6] = (P_reg[6] >>> 16);
assign X_internal[7] = (P_reg[7] >>> 16);
endmodule
