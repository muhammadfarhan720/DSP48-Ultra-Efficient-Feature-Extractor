...
//    // Initialize the static 8x9 matrix B
//    initial begin
//        B_static[0] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // First row
//        B_static[1] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // Second row
//        B_static[2] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // Third row
//        B_static[3] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // Fourth row
//        B_static[4] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // Fifth row
//        B_static[5] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // Sixth row
//        B_static[6] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // Seventh row
//        B_static[7] = {18'd1, 18'd2, 18'd3, 18'd4, 18'd5, 18'd6, 18'd7, 18'd8, 18'd9}; // Eighth row
//        B[0] = 0; 
//        B[1] = 0; B[2] = 0; 
//                B[3] = 0; B[4] = 0; B[5] = 0; 
